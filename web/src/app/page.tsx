...
import { MitsuConsole } from "@/components/mitsu-console";
...
export default function Home() {
  ...
  if (view === "loading") {
    return <div className="boot-screen"><div className="boot-pulse" aria-label="Initializing MITSU" /></div>;
  }
  ...
  if (view === "console" && user) return <MitsuConsole user={user} onSignOut={signOut} />;
  return null;
}
