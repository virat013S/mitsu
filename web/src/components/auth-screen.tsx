  ...
  return (
    <main className="entry-shell">
      <section className="entry-identity" aria-labelledby="entry-title">
        <div className="wordmark"><span className="wordmark-mark">M</span> MITSU</div>
      ...
      <section className="auth-panel" aria-labelledby="auth-title">
        ...
        <form onSubmit={submit} className="auth-form">
          {mode === "signup" && (
            <label>Display name<Input name="display_name" autoComplete="name" required placeholder="How MITSU should address you" /></label>
          )}
          ...
          <Button type="submit" disabled={pending} className="w-full">
            {pending ? "Authorizing" : mode === "login" ? "Enter MITSU" : "Create secure account"}
