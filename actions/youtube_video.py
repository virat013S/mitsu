...
def _ask_for_url(prompt_text: str = "YouTube video URL:") -> str | None:
    try:
        ...
        url = simpledialog.askstring("MITSU", prompt_text, parent=root)
...
def _save_summary(content: str, video_url: str) -> str:
    ...
    write_text_with_stamp(
        filepath,
        header + content,
        f"YouTube summary generated by MITSU for {video_url}.",
    )
