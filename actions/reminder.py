...
try:
    ...
    notification.notify(title="MITSU Reminder", message=message, timeout=15)
    notified = True
except Exception:
    pass
...
if not notified:
    try:
        ...
        ToastNotifier().show_toast("MITSU Reminder", message, duration=15, threaded=False)
        notified = True
    except Exception:
        pass
...
if not notified:
    try:
        import subprocess
        script = 'display notification "{{}}" with title "MITSU Reminder"'.format(
            message.replace('"', '')
        )
...
"""
    ...
    script_body = f"""# Auto-generated by MITSU reminder — do not edit
...
try:
    ...
    pass
"""
    write_text_with_stamp(script_path, script_body, "Reminder helper script generated by MITSU.")
...
def _schedule_windows(target_dt: datetime, task_name: str,
    ...
    xml_content = (
        ...
        '  <RegistrationInfo><Description>MITSU Reminder</Description></RegistrationInfo>\n'
    ...
    mark_created_file(xml_path, "Windows scheduled task XML generated by MITSU reminder.")
...
def _schedule_mac(target_dt: datetime, task_name: str,
    ...
    label     = f"com.mitsu.reminder.{task_name}"
...
"""
    ...
    mark_created_file(plist_path, "macOS launchd plist generated by MITSU reminder.")
...
def reminder(
    ...
    task_name  = f"MITSUReminder_{target_dt.strftime('%Y%m%d_%H%M%S')}"
